...
const TEAM_ALIASES: Record<string, string[]> = {
  ...
  Türkiye: ["Turkey", "土耳其"],
  Turkey: ["Türkiye", "土耳其"],
  // English Premier League clubs (football-data.org shortName ↔ HKJC labels)
  "Man City": ["Manchester City", "曼城"],
  "Manchester City": ["Man City", "曼城"],
  "Man United": ["Manchester United", "Man Utd", "曼聯"],
  "Manchester United": ["Man United", "Man Utd", "曼聯"],
  Tottenham: ["Tottenham Hotspur", "Spurs", "熱刺"],
  "Nott'm Forest": ["Nottingham Forest", "諾定咸森林"],
  "Nottingham Forest": ["Nott'm Forest", "諾定咸森林"],
  Wolverhampton: ["Wolves", "狼隊"],
  Wolves: ["Wolverhampton", "狼隊"],
  "Sheffield Utd": ["Sheffield United", "錫菲聯"],
  "Brighton Hove": ["Brighton", "白禮頓"],
  Arsenal: ["阿仙奴"],
  Chelsea: ["車路士"],
  Liverpool: ["利物浦"],
  Everton: ["愛華頓"],
  "Newcastle": ["Newcastle United", "紐卡素"],
  "West Ham": ["West Ham United", "韋斯咸"],
  "Aston Villa": ["阿士東維拉"],
  Fulham: ["富咸"],
  Brentford: ["賓福特"],
  "Crystal Palace": ["水晶宮"],
  Bournemouth: ["AFC Bournemouth", "般尼茅夫"],
  Sunderland: ["新特蘭"],
  Burnley: ["般尼"],
  "Leeds United": ["Leeds", "列斯聯"],
};
